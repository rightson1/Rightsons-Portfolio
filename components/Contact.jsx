...
const Contact = () => {
    ...
    return <Box className="py-10 ">
        <div className="flex flex-col px-5 py-10">
            <Typography className="text-center md:text-start font-quicksand text-[30px] md:text-4xl ">
                Contact Us
            </Typography>
            <Typography className="text-center md:text-start font-jost text-2xl text-[700]">
                Lets talk
            </Typography>
        </div>
        ...
        <Grid container className="p-5" spacing={5}>
            <Grid item xs={12} md={6} className="flex flex-col items-start gap-2">
                <Typography className="text-start tracking-wide font-quicksand text-3xl">
                    Your name
                </Typography>
                <input type="text" className="w-full p-4 bg-gray-200 font-quest rounded-md outline-none" />
            ...
            <Grid item xs={12} md={6} className="flex flex-col items-start gap-2 ">
                ...
                <select type="text" className="w-full p-4 bg-gray-200 font-quest rounded-md outline-none " >
            ...
            <Grid item xs={12} md={12} className="flex flex-col items-start gap-2 ">
                ...
                <textarea type="text" placeholder="Let Me Know About Your Project" className="w-full p-4 bg-gray-200 font-quest rounded-md outline-none h-[150px]" />
            </Grid>
            <Grid item xs={12} md={12} className="flex flex-col items-start gap-2 ">
